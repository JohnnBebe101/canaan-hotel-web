...
function initializeStorage() {
  ...
  storage.rooms.set('standard-room', {
    ...
    max_guests: 2,
    is_active: true,
    image_src: '/images/Bed-Single.svg',
  ...
  storage.rooms.set('deluxe-room', {
    ...
    max_guests: 2,
    is_active: true,
    image_src: '/images/Twin-Room.svg',
  ...
  storage.rooms.set('family-room', {
    ...
    max_guests: 4,
    is_active: true,
    image_src: '/images/Room-Larger.svg',
  ...
  storage.rooms.set('suite', {
    ...
    max_guests: 2,
    is_active: true,
    image_src: '/images/Room-Best-View.svg',
  ...
  storage.attractions.set('gheralta', {
    ...
    distance: '65 km',
    image: '/assets/images/Gheralta.svg',
    is_active: true,
    created_at: new Date().toISOString(),
  });
  ...
  storage.attractions.set('al-nejashi', {
    ...
    category: 'Religious Site',
    distance: '30 km',
    image: '/assets/images/Al Najashi5.svg',
    is_active: true,
    created_at: new Date().toISOString(),
  });
  ...
  storage.blogs.set('gheralta-mountains-tigray', {
    ...
    featured_image: '/assets/images/Gheralta.svg',
  ...
  storage.blogs.set('al-nejashi-mosque-history', {
    ...
    featured_image: '/assets/images/Al Najashi5.svg',
    author: 'Canaan Hotel Team',
    published_at: new Date().toISOString(),
    is_published: true,
    created_at: new Date().toISOString(),
